  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (authError) {
      ...
      /* If email confirmation is disabled in Supabase, the user is
         signed in immediately — redirect to app. If confirmation is
         enabled, show the "check your email" message. */
    ...
    return (
      <div style={{
        ...
        <div style={{
          ...
          <h1 style={{ margin: '0 0 8px', fontSize: '20px', fontWeight: 700, color: '#111827' }}>
            Revisa tu correo
          </h1>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ margin: '0 0 28px', fontSize: '14px', color: '#6B7280' }}>
          Empieza a construir tus hábitos financieros hoy.
        </p>
